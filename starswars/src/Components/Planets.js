...
import Content from '../Components/Planetscontent'
            ...
            <div class="col-md-9">
                ...
                <div className="ui search" style={{marginLeft: 300}}>
                    <div className="ui icon input search">
                        <input className="prompt" type="text" placeholder="Search Planets" ref="search" onChange={() => { this.cari(this.refs.search.value); }} />
